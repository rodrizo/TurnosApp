    ...
    public class MedicoController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var medico = await _context.Medico
                ...
                .ThenInclude(e => e.Especialidad).FirstOrDefaultAsync(); /*Obtenemos el registro correspondiente
                a ese médico con su especialidad*/
        ...
        public IActionResult Create()
        {
            ...
            /*ViewData sirve como matriz, su función será contener todos los registros de la tabla especialidad*/
            return View();
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            .Include(me => me.MedicoEspecialidad).FirstOrDefaultAsync(); /*Colocamos el registro de la tabla MedicoEspecialidad*/
        ...
        /*Primero le pasamos el contexto, nos muestra todos los registos de la tabla especialidad
    por otra parte, la propiedad value será el IdEspecialidad, el otro parámetro, será el campo que se va a mostrar
    en la lista, y por último, le damos el valor por default, en este caso es acceder a la especialidad almacenada, 
    y luego al campo IdEspecialidad*/
        ...
        public async Task<IActionResult> Edit(int id, [Bind("IdMedico,Nombre,Apellido,Direccion,Telefono,Email,HorarioAtencionDesde,HorarioAtencionHasta")] Medico medico, int IdEspecialidad)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    _context.Remove(medicoEspecialidad); /*Elimina el registro porque EF no permite modificar Primary Keys
                    por ende, se procede a remover el registro, y crear uno nuevo instantáneamente*/
                    await _context.SaveChangesAsync();
        ...
        {
            var medicoEspecialidad = await _context.MedicoEspecialidad
            .FirstOrDefaultAsync(me => me.IdMedico == id); /*Igualamos el id del médico al id que trae la petición*/

            /*PROCEDEMOS a eliminar primero el registro de medicoEspecialidad
            dado que en esa tabla se encuentra nuestra FK, posteriormente, procedemos a eliminar todo el registro*/
            _context.MedicoEspecialidad.Remove(medicoEspecialidad); /*Eliminamos el registro del médico*/
            await _context.SaveChangesAsync();
        ...
        public string TraerHorarioAtencionDesde(int idMedico)
        {
            ...
            /*Obtenemos el valor de la propiedad del HORARIO, o bien, los valores*/
            return HorarioAtencionDesde.Hour + ":" + HorarioAtencionDesde.Minute; /*Retornamos horas y minutos*/
        }
        ...
        public string TraerHorarioAtencionHasta(int idMedico)
        {
            ...
            /*Obtenemos el valor de la propiedad del HORARIO, o bien, los valores*/
            return HorarioAtencionHasta.Hour + ":" + HorarioAtencionHasta.Minute; /*Retornamos horas y minutos*/
        }
